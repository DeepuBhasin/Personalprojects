...
<div class="section-container">
    ...
    <?php if (isset($response['status'])) : ?>
        <center>
        <table style="width: 700px; position:relative; left:-100px;">
            <thead>
                <tr>
                <th>Sri</th>
                <th>Name</th>
                ...
                foreach ($response['data'] as $value) : ?>
                    <tr>
                        ...
                        <td style="width: 200px;">
                            <a style="text-decoration:none; color:#000; padding:5px; background-color: white;" href="viewfriendprofile.php?id=<?= $value['id'] ?>">View Profile</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
            </table>
