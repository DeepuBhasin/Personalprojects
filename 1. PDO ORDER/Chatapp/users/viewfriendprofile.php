...
<div class="section-container">
  ...
  <div class="section-form" style="text-align: center;">
    ...
    <?php if($friendRquest === false): ?>
      <a style="top: 20px; position:relative; text-decoration:none;" class="btn-success" href="sendfriendrequest.php?id=<?= $page_data['id']; ?>">Send Friend Request </a>
    <?php elseif($friendRquest['status'] == 0): ?>
      <br/>
      <h3>Wait for Request Confirmation</h3>
    <?php elseif( $friendRquest['status'] == 1): ?>
      <br/>
      <h2>Friends</h2>
    <?php endif;?>  
    </center>
