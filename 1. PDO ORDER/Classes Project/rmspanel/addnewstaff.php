...
$status=1;
	...
	$newUser = $userObj::addstaff($fname,$lname,$emailidf,$emailids,$password,$admintype,$status);
	...
	<?php unset($_SESSION['msg']); } ?>
			                	<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
									...
									<div class="form-group">
										...
										<input type="email" class="form-control" placeholder="example@gmail.com" name="emailidf">
									</div>
									
									<div class="form-group">
										<label>Your Email Id(Optional):</label>
										<input type="email" class="form-control" placeholder="example@gmail.com" name="emailids">
									</div>
								...
								<div class="form-group mb-3 mb-md-2">
									...
									<div class="custom-control custom-control-right custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="admintype" id="custom_radio_inline_right_checked" value="1" checked="">
										<label class="custom-control-label position-static" for="custom_radio_inline_right_checked">Staff</label>
									</div>

									<div class="custom-control custom-control-right custom-radio custom-control-inline">
										<input type="radio" class="custom-control-input" name="admintype" id="custom_radio_inline_right_unchecked" value="2">
									...
									<div class="d-flex justify-content-between align-items-center">
										...
										<button type="submit" class="btn bg-blue" name="submit" value="submit">Submit <i class="icon-paperplane ml-2"></i></button>
									</div>
								</form>
							</div>
		                </div>
