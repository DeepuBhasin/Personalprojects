...
$getclient = $clientObj::getallclients();
...
if(isset($_GET['cid']) && isset($_GET['action']))
{
  ...
  {
    $cid = $_GET['cid'];
    $statusClientDel = $clientObj::deleteClient($cid);
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="content">
                ...
                while($client_data = mysqli_fetch_array($getclient['result'])){?>


								<td><?php echo $x ;?></td>

								<td><?php echo $client_data['cfname']." ".$client_data['clname'];?></td>

								<td><?php echo $client_data['cemailf']?></td>

								<td><?php echo $client_data['cemails']?></td>
									...
									<div class="list-icons">
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="editclient.php?cid=<?php echo $client_data['cid']; ?>" class="dropdown-item"> Update</a>

												<a onclick="confirmDelete('<?php echo $client_data['cid']; ?>')" style="cursor:pointer" class="dropdown-item"  rel='tooltip' data-placement="top" title="Delete Client from system"> Delete</a>
...
function confirmDelete(cid)
  {
    ...
    if(flag)
    {
      location.href = '?action=del&cid='+cid;
    }
  }
</script>
