...
if(isset($_GET['id']) && isset($_GET['action']))
{
  ...
  {
    $id = $_GET['id'];
    $statusClientDel = $userObj::deleteStaff($id);
	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				...
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="page-title d-flex">
						...
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">All Staff Details</span></h4>
			...
			<div class="content">
                ...
                while($client_data = mysqli_fetch_array($getstaff['result'])){?>
							...
							<tr>
								...
								<td><?php echo $client_data['emailidf']?></a></td>

								<td><?php echo $client_data['emailids']?></td>

								

					<td><i data="<?php echo $client_data['id'];?>" class="status_checks btn
  <?php echo ($client_data['status'])?
  'btn-success': 'btn-danger'?>"><?php echo ($client_data['status'])? 'Active' : 'Inactive'?>
 </i></td>

							<!--	<td><button type="button" class="but" name="sub"  id="sub">Active</button>
  <button type="button" class="but" name="save" id="save" disabled value="true">Deactive</button></td>-->
									...
									<div class="list-icons">
										...
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												...
												<a href="updatestaff.php?id=<?php echo $client_data['id']; ?>" class="dropdown-item"> Update</a>

												<a onclick="confirmDelete('<?php echo $client_data['id']; ?>')" style="cursor:pointer" class="dropdown-item"  rel='tooltip' data-placement="top" title="Delete Staff from system"> Delete</a>
