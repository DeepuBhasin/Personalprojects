...
$fetchclient=$clientObj::fetchClient($cid);
$client_data = mysqli_fetch_array($fetchclient['result']);
...
$supportsmomanager=$_POST['supportsmomanager'];
	...
	$newUser = $clientObj::editClient($cid,$cfname,$clname,$cemailf,$cemails,$cemailt,$cphone,$cmob,$currency,$cpassword,$cstreetaddress,$ccity,$cstate,$ccountry,$accountmanager,$revenuemanager,$supportrevenuemanager,$smomanager,$supportsmomanager);
...
<body class="navbar-top">
	...
	<?php unset($_SESSION['msg']); } ?>
						<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
						    <input name="id" type="hidden" value="<?php echo $client_data['cid'];?>" />
							<div class="row">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" placeholder="First name" class="form-control" name="cfname" value="<?php echo $client_data['cfname']; ?>">
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" placeholder="Last name" class="form-control" name="clname" value="<?php echo $client_data['clname']; ?>">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="email" placeholder="Email" class="form-control" name="cemailf" value="<?php echo $client_data['cemailf']; ?>">
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="email" placeholder="Email" class="form-control" name="cemails" value="<?php echo $client_data['cemails']; ?>">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="email" placeholder="Email" class="form-control" name="cemailt" value="<?php echo $client_data['cemailt']; ?>">
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" placeholder="+99-99-9999-9999" class="form-control" name="cphone" value="<?php echo $client_data['cphone']; ?>">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" placeholder="+99-99-9999-9999" class="form-control" name="cmob" value="<?php echo $client_data['cmob']; ?>">
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
						                            ...
						                            <select data-placeholder="Select your currency" name="currency" class="form-control form-control-select2" data-fouc >
						                            	<option value="<?php echo $client_data['currency']; ?>"><?php echo $client_data['currency']; ?></option>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="password" placeholder="Password" name="cpassword" class="form-control" value="<?php echo $client_data['cpassword']; ?>">
												</div>
											</div>
										</div>
									</fieldset>
									...
									<fieldset>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" placeholder="Street Address" name="cstreetaddress" class="form-control"  value="<?php echo $client_data['cstreetaddress']; ?>">
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
													<label>City:</label>
													<input type="text" placeholder="City" class="form-control" name="ccity"  value="<?php echo $client_data['ccity']; ?>">
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>State:</label>
													<input type="text" placeholder="State" class="form-control" name="cstate"  value="<?php echo $client_data['cstate']; ?>">
												</div>
											</div>
											...
											<div class="col-md-4">
												<div class="form-group">
													<label>Country:</label>
													<input type="text" placeholder="Country" class="form-control" name="ccountry"  value="<?php echo $client_data['ccountry']; ?>">
												</div>
											</div>
										</div>
...
<?php 
                    ...
                    ?>
                  <option value="<?php echo $rowapp['id'];?>" <?php if($client_data['accountmanager'] == $rowapp['id']){ echo "selected"; } ?>><?php echo $rowapp['fname']." ".$rowapp['lname'];?></option>
                  <?php } ?>
		...
		<?php 
                    ...
                    ?>
                  <option value="<?php echo $rowapp['id'];?>" <?php if($client_data['revenuemanager'] == $rowapp['id']){ echo "selected"; } ?>><?php echo $rowapp['fname']." ".$rowapp['lname'];?></option>
                  <?php } ?>
		...
		<?php 
                    ...
                    ?>
                  <option value="<?php echo $rowapp['id'];?>" <?php if($client_data['supportrevenuemanager'] == $rowapp['id']){ echo "selected"; } ?>><?php echo $rowapp['fname']." ".$rowapp['lname'];?></option>
                  <?php } ?>
											...
											<div class="col-md-6">
												<div class="form-group">
						                            <label>SMO Manager:</label>
						                             ...
						                             <?php 
                       while ($rowapp=mysqli_fetch_array($getstaff3['result'])) {
                    ?>
                  <option value="<?php echo $rowapp['id'];?>" <?php if($client_data['smomanager'] == $rowapp['id']){ echo "selected"; } ?>><?php echo $rowapp['fname']." ".$rowapp['lname'];?></option>
                  <?php } ?>
                    ...
                    ?>
                  <option value="<?php echo $rowapp['id'];?>" <?php if($client_data['supportsmomanager'] == $rowapp['id']){ echo "selected"; } ?>><?php echo $rowapp['fname']." ".$rowapp['lname'];?></option>
                  <?php } ?>                    </select>
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary" name="update">Submit form <i class="icon-paperplane ml-2"></i></button>
							</div>
						</form>
					</div>
				</div>
