                                    ...
                                    <div class="col-4">
                                        <div class="woocommerce-billing-fields">
                                           <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT o.id,o.offer,o.accepted,o.submitted,o.message_status,h.title,h.image FROM offer as o INNER JOIN hammer as h on h.id=o.hammer_id WHERE o.send_to=$id ORDER BY o.submitted DESC";
                                                            ...
                                                            while($row=mysqli_fetch_assoc($query)){
                                                                ...
                                                                <tr>
                                                                   ...
                                                                   <?php }else if ($status==2){?>
                                                                    ...
                                                                    <td><a href="receiveInbox.php?id=<?= $row['id']?>" class="btn btn-success" onclick="confirm('Are you sure you want to do chat with Seller ? ');" >Make Chat</a></td>
                                                                </tr>
                                                                <?php
                                                            }
                                                        }else{
