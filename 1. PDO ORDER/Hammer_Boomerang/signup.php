...
if(isset($_POST['submit'])){
     include_once '__db.php';
        ...
        if(mysqli_num_rows($query)==0)
        {
            ...
            $sql = "INSERT INTO user VALUES (NULL,'$username','$name','$emailid','$hashed_password','$location')";
            $query = mysqli_query($con,$sql);
            if($query)
            {
                                            ...
                                            <p id="billing_company_field" class="form-row form-row-wide">
                                              ...
                                              <p id="billing_company_field" class="form-row form-row-wide">
                                                <label class="" for="location">Location * </label>
                                                 <input type="text" placeholder="Enter Location Id" id="location" name="location" class="input-text">
                                            </p>  
                                            <p><button type="submit" name="submit" class="btn-sm btn btn-success"> Sign Up</button></p>
                                        </div>
                                    </div>
                                </div>
                            </form>
