...
if(isset($_POST['submit']))
{
    ...
    $sql = "UPDATE user SET name='$name',email='$email',location='$location' where id=$id";
                                            ...
                                            <p id="billing_company_field" class="form-row form-row-wide">
                                             ...
                                             <p id="billing_company_field" class="form-row form-row-wide">
                                                <label class="" for="emailid">Email * </label>
                                                 <input type="email" value="" placeholder="Enter Email" id="emailid" name="email" class="input-text" style="width: 100%;" required="">
                                            </p>
                                            <p id="billing_company_field" class="form-row form-row-wide">
                                                <label class="" for="location">Location * </label>
                                                 <input type="text" value="" placeholder="Enter Location" id="location" name="location" class="input-text" style="width: 100%;" required="">
                                            </p>
