                   ...
                   <div class="panel-body">
                      <div class="table-responsive">
                        <table class="table table-hover table-striped table-hover" id="myTable">
                            ...
                            <tbody>
                            <?php 
                            $query=mysqli_query($con,"SELECT * FROM user where mobile_number IS NOT NULL  and status=1 order by full_name ASC");
                            $c=0;
                            ...
                            <tr>
                                ...
                                <td><?= $ab['remarks']?></td>
                                <td><?= $ab['created_dt'];?></td>
                                <td><?= isset($ab['updated_dt'])?$ab['updated_dt']:'Not Available';?></td>
