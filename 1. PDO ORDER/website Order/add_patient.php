            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                 <div class="content-row">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <div class="panel-title"><b>Add Patient</b>
                      </div>
                    </div>
                   <div class="panel-body">
                      <form role="form" action="program_file.php" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="illness" id="illness"  required="required" autocomplete="off" placeholder="Enter Illness ">
                        </div>
                        <div class="form-group">
                          <label for="allergies">Allergies *</label>
                          <input type="text" class="form-control" name="allergies" id="allergies"  required="required" autocomplete="off" placeholder="Enter Allergies ">
                        </div>
                        <div class="form-group">
                          <label for="physician">Physician *</label>
                          <input type="text" class="form-control" name="physician" id="physician"  required="required" autocomplete="off" placeholder="Enter Physician ">
                        </div>
                        ...
                        <button type="submit" class="btn btn-success" name="add_patient">Add</button> <button type="reset" class="btn btn-info">Reset</button>
                      </form>
                    </div>
                  </div>
