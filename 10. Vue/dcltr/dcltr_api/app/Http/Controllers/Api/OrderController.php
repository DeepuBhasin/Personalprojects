...
class OrderController extends Controller
{
    ...
    {
        $user = auth()->user();
        $data = Order::select('id','product_id','address_id')
        ->with(['shipping_address', 'product_details','payment_details','uploads' => function($q) {
        ...
        if (!empty($data)){
            ...
            return response()->json(['message' => __('apiMessage.noOrderExist')]);
        }
    }
}