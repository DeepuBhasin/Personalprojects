    ...
    public function toArray($request)
    {
        ...
        return [
           ...
           // "address_id" => $this->address_id,
            ...
            "ia" => $this->ia()?->get(),
            "da" => $this->da()?->get(),
            "bids" => $this->bids()?->where('added_by',auth()->user()->id)->latest()->get(),
            "bids_for_admin" => $this->bids()?->with('user', 'user.bankDetail', 'order', 'order.payments', 'order.shipping_address')->latest()->get(),
            ...
            "is_bid_accepted" => $this->is_bid_accepted,
        ];
    }
}
