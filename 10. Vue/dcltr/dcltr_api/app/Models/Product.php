...
class Product extends Model
{
    ...
    protected function getStatusTextAttribute()
    {
        if (isset($this->status)) {
            return array_flip(config('constants.productStatus'))[$this->status];
        }
    }
    ...
    {
        return $this->hasMany("App\Models\Upload", 'ref_id')->select(['id', 'filename', 'filetype', 'ref_id', 'filepath']);
    }
     ...
     */
    public function ia(){
        return $this->belongsTo(Admin::class, 'inspection_agent')->with('bankDetail');
    }
     ...
     */
    public function da(){
        return $this->belongsTo(Admin::class, 'delivery_boy')->with('bankDetail');
    }
