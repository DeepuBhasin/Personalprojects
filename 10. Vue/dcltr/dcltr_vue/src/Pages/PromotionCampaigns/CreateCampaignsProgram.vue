<template>
    <SectionHeader header="Create Program" :titleBoolen="true">
                ...
                <form action="" method="post" @submit.prevent="onSubmit" autocomplete="off" class="col-md-12">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <p v-if="v$.select_country.$dirty && v$.select_country.required.$invalid" class="text-danger error-message">
                                {{ v$.select_country.required.$message }}
                            </p>
                        </div>
                        <div class="form-group">
                            ...
                            <p v-if="v$.select_state.$dirty && v$.select_state.required.$invalid" class="text-danger error-message">
                                {{ v$.select_state.required.$message }}
                            </p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <p v-if="v$.select_city.$dirty && v$.select_city.required.$invalid" class="text-danger error-message">
                                {{ v$.select_city.required.$message }}
                            </p>
                        </div>
...
import {postRequestForImage,getRequest} from "@/store/api.js";
            ...
            if (this.v$.$error) {
                ...
                if(from_date > to_date) {
                    ...
                    if(this.promotional_image ==null){
                        alert('Please Select Promotional Image');
                        return false;    
                    }
                    // for adding image in form object
                    fd.append('image', this.promotional_image, this.promotional_image.name);
                    
                   let responseData =  await postRequestForImage('admin/campaign',fd);
                    if(responseData.status === 200 || responseData.status === 201) {
                        this.show('Campaign Created Successfully','success', 3000);
                        setTimeout(() => {
                            this.$router.go(-1);
                        }, 500);
                    } else {
