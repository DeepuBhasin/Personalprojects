...
(1, '1QA', '2021-09-01', '05:13:28', '12:00:22', 'YBBN', 'YSSY', 1256, 1),
(2, '1QA', '2021-09-03', '11:06:01', '22:06:01', 'YBRK', 'YSSY', 4521, 1),
(3, '1QA', '2021-09-04', '08:29:13', '16:29:06', 'YSSY', 'YBBN', 2351, 1),
(4, '2JE', '2021-09-07', '22:27:07', '35:10:07', 'YBBN', 'YSSY', 1234, 2),
...
(10, '1QA', '2021-09-19', '05:13:28', '12:00:22', 'YBBN', 'YSSY', 7541, 1),
...
DELIMITER //
CREATE PROCEDURE sp_flightListRockhamptonBrisbane()
BEGIN
SELECT ft.fight_no,ft.flght_date,ft.departure_time,ft.arrival_time,ft.departure_time,ft.arrival_time,at_dep.airport_name,at_arv.airport_name,ft.price FROM flight_table as ft 
...
WHERE at_dep.airport_name="Rockhampton Airport" and at_arv.airport_name="Brisbane International Airport";
END //
DELIMITER ;

Call sp_flightListRockhamptonBrisbane();


DELIMITER //
CREATE PROCEDURE sp_flightListRockhamptonBrisbaneExcel()
BEGIN
SELECT ft.fight_no,ft.flght_date,ft.departure_time,ft.arrival_time,ft.departure_time,ft.arrival_time,at_dep.airport_name,at_arv.airport_name,ft.price FROM flight_table as ft 
INNER JOIN airport_table as at_dep ON ft.departure_airport_code=at_dep.airport_code
INNER JOIN airport_table as at_arv ON ft.arrival_airport_code=at_arv.airport_code
INNER JOIN air_line_table as alt ON alt.air_line_code=ft.fight_no
WHERE at_dep.airport_name="Rockhampton Airport" and at_arv.airport_name="Brisbane International Airport"
INTO OUTFILE 'C:/Users/HP/Desktop/RockhamptonBrisbane.xls' FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n';
END //
DELIMITER ;

Call sp_flightListRockhamptonBrisbaneExcel();


DELIMITER //
CREATE PROCEDURE sp_fligtListSydneyto(IN airport_name varchar(300))
BEGIN
SELECT ft.fight_no,ft.flght_date,ft.departure_time,ft.arrival_time,ft.departure_time,ft.arrival_time,at_dep.airport_name,at_arv.airport_name,ft.price FROM flight_table as ft 
INNER JOIN airport_table as at_dep ON ft.departure_airport_code=at_dep.airport_code
INNER JOIN airport_table as at_arv ON ft.arrival_airport_code=at_arv.airport_code
INNER JOIN air_line_table as alt ON alt.air_line_code=ft.fight_no
WHERE at_dep.airport_name="Sydney Airport" and at_arv.airport_name=airport_name;
End //
DELIMITER ;

Call sp_fligtListSydneyto("Brisbane International Airport");
